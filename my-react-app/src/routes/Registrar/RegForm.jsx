...
function RegForm() {
    ...
    function lidarMudancaEmail(e){
        setEmail(s => s = e.target.value)
    }
            ...
            <div className=" col-sm-12 col-md-12  p-4 pt-4  ">
                <section className="login-session row gap-3 justify-content-center text-light">
                    ...
                    <form onSubmit={lidarSubmit} className="login_form ">
                        ...
                        <div className="mb-4">
                                <label htmlFor="email" className="email form-label m-0">E-mail</label>
                                <input 
                                    type="email"
                                    className="form-control border-light bg-transparent text-light ps-1 pb-0t" id="email"
                                    required 
                                    placeholder="exemplo@gmail.com" 
                                    name="email"
                                    onChange={lidarMudancaEmail}
                                    />
                            </div>
                        <div className="mb-4">
